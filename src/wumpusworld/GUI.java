...
/**
 * GUI for the Wumpus World. Only supports worlds of size 4.
 *
...
public class GUI implements ActionListener {
    ...
    /* Debug stuff */
    static final boolean showNeuralPanel = false;
    public NeuralStatePanel neuralPanel;
    static public GUI instance;

    static public void updateNeuralStatePanel() {
        if (instance == null || !showNeuralPanel)
            return;
        instance.neuralPanel.update();
    ...
    private void createWindow() {
        ...
        if (showNeuralPanel) {
            neuralPanel = new NeuralStatePanel();
            frame.getContentPane().add(neuralPanel);
        }
